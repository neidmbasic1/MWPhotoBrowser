...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    browser.backgroundColor = [UIColor redColor];
    browser.navBarBarTintColor = [UIColor purpleColor];
    browser.navBarTintColor = [UIColor whiteColor];
    browser.barStyle = UIBarStyleBlackTranslucent;
    
    [browser setCurrentPhotoIndex:0];
    
//    self.navigationController.navigationItem.titleView = [[UIImageView alloc]initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"photo1t" ofType:@"jpg"]]];
